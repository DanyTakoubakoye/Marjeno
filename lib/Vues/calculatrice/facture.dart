...
class Facture extends StatefulWidget {
  ...
  @override
  _Facture createState() => _Facture();
}

class _Facture extends State<Facture> {
  ...
  double _calculateTotalPrixLingot() {
    return rows.fold(0.0, (T, row) => T + row['Prix Lingot']);
  }
            ...
            child: SingleChildScrollView(
              ...
              child: Table(
                ...
                columnWidths: const <int, TableColumnWidth>{
                  0: FixedColumnWidth(50), // largeur de la colonnne "N°"
                  1: FixedColumnWidth(120),
                  2: FixedColumnWidth(120),
                  3: FixedColumnWidth(120),
                  4: FixedColumnWidth(120),
                  5: FixedColumnWidth(50), // largeur de la colonnne "Action"
                },
                children: [
                  TableRow(
  ...
  Widget _buildTextCell(String text) {
    return Padding(
      padding: const EdgeInsets.only(top: 25, bottom: 22, right: 10),
      child: Center(
        child: Text(
          text,
          style: const TextStyle(
